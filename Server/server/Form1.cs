                ...
                try
                {
                    ...
                    if (statusCode == "220")
                    {
                        ...
                        {   // construction filename contd. file numbers added for multiple submission
                            ...
                            string willAdded = newFile.uName + ";" + newFile.fName + ";" + newFile.count + ";" + newFile.size + ";" + newFile.date + ";\n";
                    ...
                    else if (statusCode == "240")//File request
                    {
                        ...
                        foreach (FileOfClient line in AllFiles)
                        {
                            if (line.uName == username)
                                sendLine += line.uName + ";" + line.fName + ";" + line.count.ToString() + ";" + line.size + ";" + line.date + "\n";
                        }
                        Byte[] buffer2 = Encoding.Default.GetBytes(sendLine);
                        thisClient.Send(buffer2);

                    }
                    else if (statusCode == "260")//Download request
                    {
                        logs.AppendText("\n<" + statusCode + ">\n" + incomingMessage + "\n");
                    }
                    else if (statusCode == "280")//Copy File
                    {
                        ...
                        foreach (string line in filelines)
                        {
                            ...
                            if (line != "")
                            {
                                ...
                                file.uName = username;
                                file.fName = fileEntry[0];
                                file.count = Int32.Parse(fileEntry[1]);
                                file.date = fileEntry[3];
                                file.size = fileEntry[2];
                                ...
                                if (file.count != 0)
                                {
                                    ...
                                    filename_tocopy_infolder = username + fileEntry[0];
                                ...
                                */
                                ...
                                file.count = max;
                                AllFiles.Add(file);
                                string willAdded = file.uName + ";" + file.fName + ";" + file.count.ToString() + ";" + file.size + ";" + file.date + ";\n";
                                File.AppendAllText(path + "DB.txt", willAdded);
                        ...
                        foreach (string line in filelines)
                        {
                            ...
                            if (line != "")
                            {
                                ...
                                if (file.count != 0)
                                {
                                    ...
                                    filename_todelete_infolder = username + fileEntry[0];

                                


                                string willRemoved = file.uName + ";" + file.fName + ";" + file.count.ToString() + ";" + file.size + ";" + file.date + ";";
